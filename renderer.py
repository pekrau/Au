"Render Marko AST to a tk.Text instance, setting tags and callbacks."
...
class Renderer:
    ...
    def __init__(self, main, viewer, view):
        """'main': the 'Main' instance.
        'viewer': the instance of a subclass of BaseViewer.
        'view': an instance of tk.Text.
        """
        self.main = main
        self.viewer = viewer
        self.view = view
    ...
    def get_dump(self, first, last):
        "Get the dump of the Tk.Text contents; cleanup and preprocess it."
