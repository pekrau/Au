...
DEFAULT_ROOT_GEOMETRY = "1000x400+700+0"
...
H6 = dict(
    tag="h6", font=(FONT_NORMAL_FAMILY, FONT_NORMAL_SIZE), left_margin=10, spacing=5
)
...
DOCX_LANGUAGES = ("sv-SE", "en-US", "en-GB")
DOCX_QUOTE_STYLE = "Quote Au"
DOCX_QUOTE_FONT = "Verdana"
DOCX_QUOTE_LEFT_INDENT = 30
DOCX_QUOTE_RIGHT_INDENT = 70
