"Mixins for classes handling a Text widget."
...
class RendererMixin:
    "Mixin for rendering Markdown AST into Text widget content."
...
class EditorMixin(RendererMixin):
    ...
    def setup_text(self, parent):
        ...
        self.text_frame = ttk.Frame(parent, padding=2)
